...
export const availableEffects = [
  ...
  { name: "Armor - All", domains: ["Sorcery", "Earth", "Nature"], modifierType: 'add', amount: 2, hasTiers: true, description: " gains [tier] Armor point(s) on every body part" },
  { name: "Armor", domains: ["Sorcery", "Earth", "Nature"], modifierType: 'add', amount: 4, hasTiers: true, description: " gains [tier * 3] Armor point(s) to some body part" },
  { name: "Armor - Specific", domains: ["Sorcery", "Earth", "Nature"], modifierType: 'add', amount: 5, hasTiers: true, description: " gains [tier * 4] Armor point(s) to [notes]" },
  { name: "Healing (1)", domains: ["Holy", "Water"], modifierType: 'add', amount: 4, hasTiers: true, description: "heals [tier] Body point(s); if it's above 5, the character makes an immidiate Infection check" },
  { name: "Healing (1d10)", domains: ["Holy", "Nature"], modifierType: 'add', amount: 15, hasTiers: true, description: "heals [tier]d10 Body points;  if it's above 5, the character makes an immidiate Infection check" },
  ...
  { name: "Weaken Item", domains: ["Fire", "Water", "Earth"], modifierType: 'add', amount: 5, hasTiers: true, description: "Subtracts [tier] structure points to the [notes] item" },
  { name: "Weaken Item (Necro)", domains: ["Necromancy"], modifierType: 'add', amount: 3, hasTiers: true, description: "Subtracts [tier] structure points to the [notes] item" },
  ...
  { name: "Apply Movement Condition", domains: ["Water", "Earth", "Nature"], modifierType: 'function', amount: 'movementCondition', hasTiers: true, maxTier: 3, description: "is trapped, {movementConditionDesc([tier])}" },
  { name: "Apply Dazed Condition", domains: ["Illusion", "Nature"], modifierType: 'add', amount: 16, hasTiers: true, maxTier: 5, description: "gets disadvantage -[tier*2] to EMP and STR" },
  { name: "Apply Blinded Condition", domains: ["Illusion", "Nature"], modifierType: 'add', amount: 16, hasTiers: true, maxTier: 5, description: "gets disadvantage -[tier*2] to DEX and INT" },
  { name: "Apply Deafened Condition", domains: ["Illusion", "Nature"], modifierType: 'add', amount: 16, hasTiers: true, maxTier: 5, description: "gets disadvantage -[tier*2] to DEX and EMP" },
  { name: "Apply Confused Condition", domains: ["Mind", "Necromancy"], modifierType: 'add', amount: 16, hasTiers: true, maxTier: 5, description: "gets disadvantage -[tier*2] to EMP and INT" },
  { name: "Apply Enfeebled Condition", domains: ["Mind", "Necromancy"], modifierType: 'add', amount: 16, hasTiers: true, maxTier: 5, description: "gets disadvantage -[tier*2] to DEX and STR" },
  { name: "Apply Befuddled Condition", domains: ["Mind", "Necromancy"], modifierType: 'add', amount: 16, hasTiers: true, maxTier: 5, description: "gets disadvantage -[tier*2] to INT and STR" },
  ...
  { name: "Cure Disease", domains: ["Holy", "Nature"], modifierType: 'add', amount: 10, hasTiers: false, description: "Automatically count as a passed medical check against a disease" },
  { name: "Cure Infection", domains: ["Holy", "Water"], modifierType: 'add', amount: 10, hasTiers: false, description: "Automatically count as a passed medical check against an infection" },
  { name: "Cure Disease", domains: ["Necromancy"], modifierType: 'add', amount: 10, hasTiers: false, description: "Automatically count as a passed medical check against a disease but the target loses 1d10 Body points as their  infected cells and the ones around it become devoid of life" },
  { name: "Cure Infection", domains: ["Necromancy"], modifierType: 'add', amount: 10, hasTiers: false, description: "Automatically count as a passed medical check against an infection but the target loses 1d10 Body points as their  infected cells and the ones around it become devoid of life" },
