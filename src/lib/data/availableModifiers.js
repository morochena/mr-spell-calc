...
export const availableModifiers = [
  ...
  { name: "Charge Up", hasTiers: false, incompatible: ["Stealth"], modifierType: 'multiply', amount: .75, description: "must be the only spell you cast this turn and your last action of the turn." },
