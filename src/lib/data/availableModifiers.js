...
export const availableModifiers = [
  ...
  { name: "Charge Up", hasTiers: false, incompatible: ["Stealth", "Reaction"], modifierType: 'multiply', amount: .75, description: "must be the only spell you cast this turn and your last action of the turn." },
  ...
  { name: "Mobile Origin", prerequisite: ["Lasting"], hasTiers: true, modifierType: 'add', amount: 1, description: "origin can be moved between turns by the caster up to [tier*5]m" },
  { name: "Delay", prerequisite: ["Lasting"], hasTiers: true, modifierType: 'multiply', amount: 0.333, description: "doesn't activate immediately, but instead goes off after {halfTime()}" },
